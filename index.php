...
<head>
  ...
  <title>Kiboko Digital</title>
  <meta name="description" content="Software Developement Company">
  <meta name="Dominique" content="Kiboko Digital">
    ...
    <nav id="scrollspyNav" class="navbar navbar-expand-lg wave-bg-blue bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-sticky" data-bsb-sticky-target="#header">
      <div class="container">
        <a class="navbar-brand" href="index.php">
          <img src="./assets/img/branding/KibokoDigital-logo.png" class="bsb-tpl-logo" alt="">
        </a>
    ...
    <div class="container overflow-hidden">
      <div class="row gy-5 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <h1 class="display-5 fw-bolder mb-3">We provide easy <br><mark class="wave-highlight wave-highlight-blue"><span class="wave-font-hw display-2 text-accent fw-normal">solutions</span></mark> for startups at affordable rates.</h1>
          <p class="fs-4 mb-5">Our software development company delivers corporate and consumer applications based on our profound understanding of technologies and the markets they operate in.</p>
        ...
        <div class="col-12 col-lg-5 text-center">
          <img class="img-fluid mask-position-center-center mask-repeat-no-repeat mask-size-auto" loading="lazy" src="./assets/img/branding/KibokoDigital-logo.png" alt="" style="-webkit-mask-image: url(./assets/img/hero/hero-blob-1.svg); mask-image: url(./assets/img/hero/hero-blob-1.svg);">
        </div>
      </div>
    </div>
  </section>
  ...
  <main id="main">
      ...
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">Our Services</h2>
          </div>
        </div>
      </div>
              ...
              <div class="col-12 col-md-6">
                <div class="card border-0 border-bottom border-primary shadow-sm">
                  <div class="card-body p-4 p-xxl-5">
                    ...
                    <h4 class="display-3 fw-bold text-primary mb-0">R300</h4>
                    <p class="text-secondary mb-4">Rands / Month</p>
              ...
              <div class="col-12 col-md-6">
                <div class="card border-0 border-bottom border-primary shadow-lg pt-md-4 pb-md-4 mt-md-n4">
                  <div class="card-body p-4 p-xxl-5">
                    ...
                    <h4 class="display-3 fw-bold text-primary mb-0">R500</h4>
                    <p class="text-secondary mb-4">Rands / Month</p>
                    <ul class="list-group list-group-flush mb-4">
                      <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
    ...
    <section id="scrollspyContact" class="py-5 py-xl-8 py-xxl-16">
      <div class="container">
        <div class="row gy-5 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-lg-center">
          <div class="col-12 col-lg-6">
            <img class="img-fluid rounded" loading="lazy" src="./assets/img/branding/KibokoDigital-logo.png" alt="">
          </div>
          <div class="col-12 col-lg-6">
            ...
            <div class="d-flex mb-4">
              ...
              <div>
                ...
                <p class="mb-0">
                  <a class="link-secondary text-decoration-none" href="tel:+27813516102">+27 813516102</a>
                </p>
              </div>
            </div>
            <div class="d-flex">
              ...
              <div>
                ...
                <p>
                  <a class="link-secondary text-decoration-none" href="mailto:info@kibokodigital.com">info@kibokodigital.com</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          ...
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              ...
              <address class="mb-4">3 Knysna Road, Milnerton, Cape Town, South Africa</address>
              <p class="mb-1">
                <a class="link-secondary text-decoration-none" href="tel:+27813516102">+27 813516102</a>
              </p>
              <p class="mb-0">
        ...
        <div class="row gy-4 gy-md-0">
          <div class="col-xs-12 col-md-7 order-1 order-md-0">
            ...
            <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
              <a href="https://kibokodigital.com/" class="link-secondary text-decoration-none">Kiboko Digital © 2023</a> with <span class="text-primary">&#9829;</span>
            </div>
          </div>
